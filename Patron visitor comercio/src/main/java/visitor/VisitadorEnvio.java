...
/**
 * Calcula el costo de envio segun el peso y tipo de producto:
 * Libro $3.000/kg, Electronico $8.000/kg + $5.000 manejo, Ropa $2.500/kg.
 *
...
public class VisitadorEnvio implements ProductoVisitor {
    ...
    public String visitar(Electronico electronico) {
        ...
        return String.format("%-30s | Peso: %4.2f kg | Tarifa: $8.000/kg + manejo | Flete: $%,8.0f",
    ...
    public String visitar(Ropa ropa) {
        ...
        return String.format("%-30s | Peso: %4.2f kg | Tarifa: $2.500/kg | Flete: $%,8.0f",
